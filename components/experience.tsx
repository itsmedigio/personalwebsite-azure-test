  ...
  const commits = [
    {
      ...
      branch: "HEAD -> master",
      date: "2023-Present",
      message: "DevOps Engineer @ Intesa Sanpaolo",
      details: ["Managed mission critical Hybrid Cloud infrastructure", "Automated SQL Server configurations via AWX", "Deployed applications to Kubernetes/Openshift", "Configured Terraform infrastructure on GCP"]
    },
    {
      hash: "2c8d1",
      branch: "",
      date: "2022-2023",
      message: "Software Engineer Lead @ PreviousCompany",
      details: ["Modernized VB.NET apps to C# Microservices", "Implemented secure CI/CD pipelines in Azure DevOps", "Orchestrated container deployments on Kubernetes"]
    },
    {
      hash: "1a4f0",
      branch: "origin/legacy",
      date: "2020-2022",
      message: "Full Stack Developer @ TechCorp",
